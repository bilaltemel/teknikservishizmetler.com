...
class SMTP {
   ...
   * If arnavutkoy-arcelik-tval is specified then a connection will try and be
   * established with the server for that number of seconds.
   * If arnavutkoy-arcelik-tval is not specified the default is 30 seconds to
   ...
   * @param string $host
   * @param int $port
   * @param int $arnavutkoy-arcelik-tval
   * @return bool
   */
  public function Connect($host, $port = 0, $arnavutkoy-arcelik-tval = 30) {
    ...
    $this->smtp_conn = @fsockopen($host,    // the host of the server
                                 ...
                                 $arnavutkoy-arcelik-tval);   // give up after ? secs
    ...
    if(substr(PHP_OS, 0, 3) != "WIN") {
     ...
     if ($max != 0 && $arnavutkoy-arcelik-tval > $max) { // don't bother if unlimited
      @set_time_limit($arnavutkoy-arcelik-tval);
     }
     stream_set_timeout($this->smtp_conn, $arnavutkoy-arcelik-tval, 0);
    }
